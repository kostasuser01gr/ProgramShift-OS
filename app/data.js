/* ============================================================================
 *  app/data.js — real June 2026 schedule + derivations
 *  Source: the live CODED grid (29 employees × 30 days) mapped to human shifts.
 *  Everything the prototype shows (coverage, warnings, fairness) is COMPUTED
 *  from this data with the same rules as the Apps Script — nothing is faked.
 * ========================================================================== */
(function () {
  // --- code → human-readable shift (from the live AJ:AK table) --------------
  var CODE_TO_SHIFT = {
  ...
  // --- raw rows: [ΑΜΕ, surname, first, ...30 codes] -------------------------
  var RAW = [
    ['6044','ΨΙΣΤΑΚΗΣ','ΜΑΝΩΛΗΣ','210,210,R,210,R,208,208,210,R,210,210,R,208,208,210,210,R,210,R,208,208,210,210,R,210,R,208,208,210,210'],
    ['6069','ΤΖΑΝΙΔΑΚΗ','ΚΩΝΣΤΑΝΤΙΝΑ','301,301,301,301,301,R,R,301,301,301,301,R,R,301,301,301,301,301,301,R,R,301,301,301,301,R,R,301,301,301'],
    ['6248','ΑΝΑΣΤΑΣΑΚΗ','ΑΝΑΣΤΑΣΙΑ','208,203,R,R,203,203,203,203,203,402,R,402,402,R,R,R,213,213,206,203,203,203,R,217,217,218,213,R,R,R'],
    ['6287','ΠΑΣΠΑΛΑΚΗΣ','ΑΝΔΡΕΑΣ','217,R,R,402,402,402,402,217,217,217,217,R,R,213,208,203,R,R,402,402,402,402,402,217,217,217,R,R,203,203'],
    ['6306','ΜΑΡΝΤΟΓΙΑΝ','ΛΙΛΗ','402,402,402,402,402,R,R,203,203,R,R,203,203,203,402,402,402,402,R,R,203,203,203,203,203,203,R,R,208,208'],
    ['6400','ΔΕΣΔΕΝΑΚΗ','ΧΡΙΣΤΙΝΑ','217,217,217,217,R,R,203,R,R,206,206,206,206,206,213,213,206,203,203,R,R,301,301,R,R,218,213,213,213,R'],
    ['6537','ΣΥΡΙΓΩΝΑΚΗΣ','ΜΙΧΑΛΗΣ','R,R,206,203,206,206,206,402,402,402,R,R,402,402,217,217,R,R,402,402,402,213,213,206,206,R,R,206,206,217'],
    ['6309','ΓΡΗΓΟΡΑΚΗΣ','ΦΩΤΗΣ','213,213,206,R,203,203,R,R,R,213,213,213,206,206,206,206,R,R,301,301,301,301,301,R,R,206,206,206,213,213'],
    ['6063','ΓΑΒΡΙΛΑΚΗ','ΝΑΤΑΛΙΑ','217,R,R,402,218,218,402,R,R,203,203,203,203,203,203,R,R,217,217,217,217,R,R,402,402,402,402,402,R,R'],
    ['6245','ΤΖΩΡΑΚΑΚΗ','ΑΡΓΥΡΩ','402,402,402,R,R,402,402,R,R,203,203,217,217,217,R,R,203,203,203,203,402,213,206,203,213,R,R,402,402,402'],
    ['6539','ΤΑΜΑΣ','ΑΛΕΞΑΝΔΡΑ','206,203,R,R,217,217,217,217,217,R,R,402,402,402,402,402,R,R,203,203,203,R,R,203,203,203,203,203,402,402'],
    ['6558','ΚΟΥΡΚΟΥΡΙΔΟΥ','ΣΤΕΛΛΑ','R,R,206,206,203,203,203,203,203,203,402,R,R,402,402,R,R,402,213,208,203,203,203,203,301,208,R,R,217,217'],
    ['6543','ΚΟΛΛΑΚΗ','ΕΛΕΥΘΕΡΙΑ','203,R,R,402,402,402,402,402,213,R,402,210,R,203,203,203,203,203,R,R,402,402,402,R,R,217,217,217,R,R'],
    ['6273','POSKREKOVA','YANA','R,R,203,203,301,301,301,402,402,402,R,R,402,402,402,217,217,R,R,203,203,R,203,203,R,402,402,402,402,402'],
    ['6021','ΜΑΡΝΤΟΓΙΑΝ','ΛΥΔΙΑ','301,301,301,301,301,R,R,301,301,301,301,301,R,R,301,301,301,301,301,R,R,301,301,301,301,301,R,R,301,301'],
    ['6486','ΚΑΣΤΡΙΝΑΚΗΣ','ΓΙΑΝΝΗΣ','206,206,206,217,R,R,206,402,213,R,206,206,206,R,206,203,206,301,217,R,R,208,R,R,206,206,206,206,206,206'],
    ['6332','ΜΠΑΜΠΑΤΣΗΣ','ΜΙΧΑΛΗΣ','402,402,217,R,R,208,218,212,208,217,217,R,R,402,402,402,402,402,210,R,R,217,217,R,218,R,402,402,R,402'],
    ['6367','ΟΥΖΟΥΝΟΓΛΟΥ','ΙΑΚΩΒΟΣ','208,217,R,R,301,301,301,301,402,R,R,402,402,212,301,301,R,R,203,203,203,217,217,R,R,402,402,402,402,R'],
    ['6075','ΦΩΣΚΟΛΑΚΗΣ','ΚΩΝΣΤΑΝΤΙΝΟΣ','203,203,203,R,R,402,213,R,206,301,R,301,208,208,R,R,402,402,402,402,405,206,203,203,203,203,R,R,R,402'],
    ['6545','ΚΑΦΑΤΟΥ','ΕΛΕΝΗ','R,R,402,210,301,203,203,301,301,301,301,R,R,301,402,402,217,217,R,R,203,203,203,203,203,203,R,R,R,203'],
    ['6555','ΜΑΡΑΓΚΑΚΗ','ΑΝΝΑ','301,R,R,203,203,203,203,203,R,R,203,203,402,211,203,203,203,203,301,R,R,402,R,402,402,R,402,402,402,402'],
    ['6676','ΤΣΑΓΚΑΡΑΚΗΣ','ΠΕΤΡΟΣ','402,402,402,402,217,R,R,R,203,402,402,R,210,402,402,402,R,R,301,402,402,R,402,402,R,210,203,203,203,203'],
    ['6716','ΤΣΙΜΠΙΝΟΣ','ΜΑΝΩΛΗΣ','R,R,203,203,206,402,402,402,213,210,R,206,206,R,R,R,402,402,402,217,217,R,R,402,402,402,217,217,217,R'],
    ['6578','ΧΡΙΣΤΟΔΟΥΛΑΚΗΣ','ΜΑΝΩΛΗΣ','203,203,R,R,203,217,217,R,R,402,402,402,402,211,203,R,203,301,R,301,301,402,402,402,402,402,R,R,R,301'],
    ['6713','ΓΥΦΤΟΠΟΥΛΟΣ','ΗΛΙΑΣ','402,402,402,402,402,R,R,203,203,R,211,211,203,R,402,402,R,402,402,213,R,206,203,203,R,R,203,203,203,203'],
    ['6428','ΝΤΑΓΚΙΝΗΣ','ΝΙΚΟΣ','402,R,R,402,402,402,402,402,R,R,301,301,203,301,301,301,301,R,R,301,301,301,301,R,R,402,402,402,402,R'],
    ['6655','ΣΩΜΑΡΑΚΗΣ','ΚΩΝΣΤΑΝΤΙΝΟΣ','R,R,301,301,301,203,402,R,210,301,R,217,217,217,217,R,R,203,203,203,203,206,206,206,206,206,R,R,R,402'],
    ['6445','ΑΝΑΣΤΑΣΑΚΗ','ΜΑΡΙΑ','208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208'],
    ['6269','ΜΟΙΡΑΚΗΣ','ΓΙΑΝΝΗΣ','208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208,208,208,208,R,R,208,208']
  ];
  ...
  var requests = [
    { id: 'r1', type: 'swap',  empIdx: 5,  status: 'pending', day: 14, withIdx: 7,  el: 'Αλλαγή βάρδιας 14/6 με Γρηγοράκη', en: 'Swap 14 Jun shift with Grigorakis' },
  ...
  // --- months registry (multi-month "interconnection") -----------------------
  ...
  // Carry the roster forward and seed the grid by cycling the previous pattern.
  ...
  // --- import a schedule file → build a month ("the program is created") ------
  // Accepts CSV/TSV text: header row, then  ΑΜΕ, Επώνυμο, Όνομα, <day1..dayN>
  // Day cells may be human shifts (07:00-15:00 / ΡΕΠΟ) or numeric codes (210/R…).
  // Optional columns named "email" and "role/ρόλος" anywhere are detected and
  // excluded from the day columns — so a pre-issued role per name can be imported.
  function parseScheduleCSV(text) {
    ...
    // day columns = every column index >= 3 that is not the role/email column
    var dayIdx = [];
  ...
  // Build + register a month from parsed import (or, as a fallback, from the
  // current roster so the demo's "Create" always produces a valid month).
